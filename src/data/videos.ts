...
export const VIDEOS: VideoItem[] = [
  ...
  {
    id: 'v23',
    title: 'En hayırlınız: Kur\'an\'ı öğrenen',
    description: 'Kur\'an öğrenmenin ve öğretmenin fazileti; günlük süreklilik önerileri.',
    media: require('../../assets/videos/v23.mp4') as number,
    creator: creator('c2'),
    category: 'kuran',
    durationSec: 105,
    ageGroup: 'genel',
    kidFriendly: true,
    sources: [
      { kind: 'hadith', reference: 'Buhârî, Fedâilü\'l-Kur\'ân 21', text: 'Sizin en hayırlınız, Kur\'an\'ı öğrenen ve öğretendir.', verified: true },
    ],
    relatedVideoIds: ['v9'],
    relatedLessonIds: [],
    subtitles: [
  ...
  {
    id: 'v24',
    title: 'Tefekkür: Ayetleri düşünmek',
    description: 'Kur\'an okumanın ötesinde, ayetler üzerine düşünmenin değeri.',
    media: require('../../assets/videos/v24.mp4') as number,
    creator: creator('c1'),
    category: 'kuran',
    durationSec: 110,
    ageGroup: 'genel',
    kidFriendly: true,
    sources: [
      { kind: 'ayah', reference: 'Sâd 38:29', text: 'Sana bu mübarek kitabı, ayetlerini düşünsünler ve akıl sahipleri öğüt alsınlar diye indirdik.', verified: true },
    ],
    relatedVideoIds: ['v23'],
    relatedLessonIds: [],
    subtitles: [
  ...
  },
  {
    ...
    description: 'Peygamberimizin güler yüzü ve tebessümün sünnetteki yeri.',
    media: require('../../assets/videos/v25.mp4') as number,
    creator: creator('c4'),
    category: 'siyer',
    durationSec: 100,
    ageGroup: 'genel',
    kidFriendly: true,
    sources: [
      { kind: 'hadith', reference: 'Tirmizî, Birr 36', text: 'Kardeşine tebessüm etmen senin için bir sadakadır.', verified: true },
    ],
    relatedVideoIds: ['v4'],
    relatedLessonIds: [],
    subtitles: [
  ...
  {
    id: 'v26',
    title: 'Göklerin delilleri',
    description: 'Evrene bakışın imana açtığı pencere; tefekkürün akaid boyutu.',
    media: require('../../assets/videos/v26.mp4') as number,
    creator: creator('c1'),
    category: 'akaid',
    durationSec: 105,
    ageGroup: 'genel',
    kidFriendly: true,
    sources: [
      { kind: 'ayah', reference: 'Âl-i İmrân 3:190', text: 'Göklerin ve yerin yaratılışında, gece ile gündüzün birbiri ardınca gelişinde akıl sahipleri için deliller vardır.', verified: true },
    ],
    relatedVideoIds: ['v10'],
    relatedLessonIds: [],
    subtitles: [
  ...
  {
    id: 'v27',
    title: 'Oruçlunun iki sevinci',
    description: 'İftar anının manevi tadı ve iftar sünnetleri.',
    media: require('../../assets/videos/v27.mp4') as number,
    creator: creator('c3'),
    category: 'ramazan',
    durationSec: 100,
    ageGroup: 'genel',
    kidFriendly: true,
    sources: [
      { kind: 'hadith', reference: 'Buhârî, Savm 9', text: 'Oruçlu için iki sevinç vardır: biri iftar ettiği andaki sevinci, diğeri Rabbine kavuştuğu andaki sevincidir.', verified: true },
    ],
    relatedVideoIds: ['v8'],
    relatedLessonIds: [],
    subtitles: [
